...
export function VisionSection() {
  ...
  return (
    <section ref={sectionRef} className="relative py-24 lg:py-32 overflow-hidden" id="vision">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div>
            <blockquote
              className={`text-2xl md:text-3xl lg:text-4xl font-medium text-white leading-snug mb-8 font-[family-name:var(--font-heading)] transition-all duration-700 delay-100 ${
                isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
              }`}
            >
              &ldquo;Our purpose is to provide reliable and affordable petroleum products to help create a{" "}
              <span className="text-primary">better world for everyone.</span>&rdquo;
            </blockquote>
              ...
              <div className="relative aspect-video rounded-2xl overflow-hidden shadow-2xl">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-black/90 to-transparent">
                  <div className="flex items-center gap-3 text-white">
                    <span className="text-lg font-bold uppercase tracking-wide font-[family-name:var(--font-heading)]">
                      Watch What We Do
                    </span>
