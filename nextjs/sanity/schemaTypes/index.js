...
export const fuelCardPage = {
  ...
  fields: [
    { name: 'heroSubtitle', title: 'Hero Eyebrow', type: 'string' },
    { name: 'heroTitle', title: 'Hero Title', type: 'string' },
    { name: 'heroDescription', title: 'Hero Description', type: 'text', rows: 3 },
    cmsImageField('heroImageUrl', 'Hero Background Image', 'Recommended: 2400 × 1080 px (2.22:1 full-width hero).'),

    { name: 'introHeading', title: 'Intro Heading', type: 'string' },
    { name: 'introDescription', title: 'Intro Description', type: 'text', rows: 3 },
    {
      name: 'introBenefits', title: 'Benefit Columns', type: 'array',
      of: [{ type: 'object', fields: [
        { name: 'title', title: 'Title', type: 'string' },
        { name: 'description', title: 'Description', type: 'text', rows: 2 },
    ...
    {
      name: 'cardsList', title: 'Card Types', type: 'array',
      of: [{ type: 'object', fields: [
        { name: 'name', title: 'Card Name', type: 'string' },
        { name: 'description', title: 'Description', type: 'text', rows: 2 },
        { name: 'variant', title: 'Built-In Card Artwork', type: 'string', options: { list: [
          { title: 'Fleet (green)', value: 'fleet' },
          { title: 'Business (black)', value: 'business' },
          { title: 'Driver (grey)', value: 'driver' },
        ] }, description: 'Used when no photo is uploaded below.' },
        cmsImageField('image', 'Card Photo (optional)', 'Optional. Upload a real card photo to replace the built-in artwork. Recommended: 1000 × 630 px.'),
      ], preview: { select: { title: 'name', subtitle: 'description', media: 'image' } } }],
    },

    { name: 'equipmentHeading', title: 'Heading', type: 'string' },
    { name: 'equipmentBody', title: 'Body Text', type: 'text', rows: 3 },
    { name: 'equipmentPoints', title: 'Checklist Points', type: 'array', of: [{ type: 'string' }] },
    cmsImageField('equipmentImage1', 'Image 1 (top left)', 'Recommended: 1000 × 1250 px (4:5 portrait).'),
    { name: 'equipmentItem1Value', title: 'Callout 1 — Name', type: 'string' },
    { name: 'equipmentItem1Label', title: 'Callout 1 — Caption', type: 'string' },
    cmsImageField('equipmentImage2', 'Image 2 (bottom right)', 'Recommended: 1000 × 1250 px (4:5 portrait).'),
    { name: 'equipmentItem2Value', title: 'Callout 2 — Name', type: 'string' },
    { name: 'equipmentItem2Label', title: 'Callout 2 — Caption', type: 'string' },
    { name: 'equipmentCtaText', title: 'Link Text', type: 'string' },
    { name: 'equipmentCtaLink', title: 'Link URL', type: 'string' },

    { name: 'highlightTag', title: 'Eyebrow Tag', type: 'string' },
    { name: 'highlightHeading', title: 'Heading', type: 'string' },
    { name: 'highlightDescription', title: 'Description', type: 'text', rows: 3 },
    { name: 'highlightCtaText', title: 'Link Text', type: 'string' },
    { name: 'highlightCtaLink', title: 'Link URL', type: 'string' },
    { name: 'highlightCardBadge', title: 'Card Badge', type: 'string' },
    cmsImageField('highlightCardImage', 'Card Image', 'Recommended: 1600 × 900 px (16:9 landscape).'),
    { name: 'highlightCardHeading', title: 'Card Heading', type: 'string' },
    { name: 'highlightCardDescription', title: 'Card Description', type: 'text', rows: 3 },
    {
      name: 'highlightStats', title: 'Card Stats', type: 'array',
      of: [{ type: 'object', fields: [
        { name: 'value', title: 'Value', type: 'string' },
        { name: 'label', title: 'Label', type: 'string' },
      ], preview: { select: { title: 'value', subtitle: 'label' } } }],
    },
    { name: 'highlightCardCtaText', title: 'Card Button Text', type: 'string' },
    { name: 'highlightCardCtaLink', title: 'Card Button URL', type: 'string' },

    { name: 'applyHeading', title: 'Heading', type: 'string' },
    { name: 'applyDescription', title: 'Description', type: 'text', rows: 3 },

    { name: 'faqsHeading', title: 'FAQ Heading', type: 'string' },
    {
      name: 'faqsList', title: 'Questions', type: 'array',
      of: [{ type: 'object', fields: [
...
export const fuelTestingPage = {
  ...
  fields: [
    ...
    cmsImageField('heroImageUrl', 'Hero Background Image', 'Recommended: 2400 × 1080 px (2.22:1 full-width hero).'),
    {
      name: 'heroStats', title: 'Hero Stat Strip', type: 'array',
      of: [{ type: 'object', fields: [
        { name: 'value', title: 'Value', type: 'string' },
        { name: 'label', title: 'Label', type: 'string' },
      ], preview: { select: { title: 'value', subtitle: 'label' } } }],
    ...
    { name: 'processHeading', title: 'Section Heading', type: 'string' },
    {
      name: 'processSteps', title: 'Steps', type: 'array',
      of: [{ type: 'object', fields: [
    ...
    { name: 'parametersHeading', title: 'Section Heading', type: 'string' },
    {
      name: 'parametersList', title: 'Test Parameters', type: 'array',
      of: [{ type: 'object', fields: [
    ...
    { name: 'resultsTag', title: 'Eyebrow Tag', type: 'string' },
    { name: 'resultsHeading', title: 'Heading', type: 'string' },
    { name: 'resultsDescription', title: 'Description', type: 'text', rows: 3 },
    { name: 'resultsCtaText', title: 'Link Text', type: 'string' },
    { name: 'resultsCtaLink', title: 'Link URL', type: 'string' },
    { name: 'resultsCardBadge', title: 'Card Badge', type: 'string' },
    cmsImageField('resultsCardImage', 'Card Image', 'Recommended: 1600 × 900 px (16:9 landscape).'),
    { name: 'resultsCardHeading', title: 'Card Heading', type: 'string' },
    { name: 'resultsCardDescription', title: 'Card Description', type: 'text', rows: 3 },
    {
      name: 'resultsStats', title: 'Card Stats', type: 'array',
      of: [{ type: 'object', fields: [
        { name: 'value', title: 'Value', type: 'string' },
        { name: 'label', title: 'Label', type: 'string' },
      ], preview: { select: { title: 'value', subtitle: 'label' } } }],
    },
    { name: 'resultsCardCtaText', title: 'Card Button Text', type: 'string' },
    { name: 'resultsCardCtaLink', title: 'Card Button URL', type: 'string' },

    { name: 'requestHeading', title: 'Heading', type: 'string' },
    { name: 'requestDescription', title: 'Description', type: 'text', rows: 3 },
...
organizePageSchema(fuelCardPage, [
  ['hero', 'Hero Section'],
  ['intro', 'Intro & Benefits'],
  ['cards', 'Card Range'],
...
organizePageSchema(fuelTestingPage, [
  ['hero', 'Hero Section'],
  ['process', 'How Testing Works'],
  ['parameters', 'What We Test For'],
  ['equipment', 'Equipment Showcase'],
