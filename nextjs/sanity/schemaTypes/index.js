...
insertBeforeCta(storeLocatorPage, [
  {
    ...
    fields: [
      ...
      {name: 'mapLink', title: 'Directions Link', type: 'url'},
      {name: 'mapLinkLabel', title: 'Directions Link Label', type: 'string'},
      {name: 'phone', title: 'Phone', type: 'string'},
      {name: 'email', title: 'Email', type: 'string'},
      {name: 'hours', title: 'Hours', type: 'string'},
      {name: 'mapLoadingText', title: 'Map Loading Text', type: 'string'},
