      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div>
            ...
            <h2 className="mining-heading font-heading text-4xl md:text-5xl font-bold text-gray-900 uppercase tracking-wide leading-tight mb-6">
              {heading}
            </h2>
            <p className="mining-content text-lg md:text-xl text-gray-600 leading-relaxed mb-8">
              {content}
            </p>
            
            <div className="flex flex-wrap gap-4">
              <a href="/services" className="group inline-flex items-center gap-3 px-8 py-4 bg-primary text-white font-bold text-[13px] uppercase tracking-[0.1em] border-2 border-primary transition-all duration-300 hover:bg-primary-dark hover:border-primary-dark">
                Explore Services
              ...
              <a href="/contact" className="group inline-flex items-center gap-3 px-8 py-4 bg-transparent text-gray-900 font-bold text-[13px] uppercase tracking-[0.1em] border-2 border-gray-300 transition-all duration-300 hover:border-primary hover:text-primary">
                Get Quote
                <svg className="w-4 h-4 group-hover:translate-x-1 transition-transform" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                  <line x1="5" y1="12" x2="19" y2="12" />
                  <polyline points="12 5 19 12 12 19" />
