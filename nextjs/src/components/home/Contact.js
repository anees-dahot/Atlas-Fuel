...
export default function Contact({ data = {} }) {
  ...
  return (
    <section ref={sectionRef} className="py-16 lg:py-24 bg-white" id="contact">
      <div className="container-max">
        ...
        <div className="grid lg:grid-cols-5 gap-12">
          ...
          <div className="lg:col-span-3">
            <form className="space-y-6">
              <div className="grid sm:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    type="text"
                    placeholder="John"
                    className="w-full px-4 py-3 border border-gray-200 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all"
                  />
                </div>
                <div>
                  <label className="block text-sm font-semibold text-foreground mb-2 uppercase tracking-wide">
              ...
              <div>
                ...
                <select className="w-full px-4 py-3 border border-gray-200 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all text-gray-500">
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 border border-gray-200 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all resize-none rounded-none"
                />
              </div>

              <button
                type="submit"
                className="w-full sm:w-auto px-8 py-4 bg-primary text-white font-bold uppercase tracking-wide hover:bg-primary-dark transition-all duration-300 rounded-none"
              >
                Send Enquiry
              </button>
            </form>
          ...
          <div className="lg:col-span-2">
            <div className="bg-gray-50 p-8 space-y-8 border border-gray-200">
              {/* Phone */}
              <div
                className={cn(
