...
export default function RetailIntro({ data = {} }) {
  ...
  const subtitleColor = data.subtitleColor || '#000000'
  const subtitleSize = data.subtitleSize || '14px'
  const subtitleBorderEnabled = data.subtitleBorderEnabled || false
  const subtitleBorderColor = data.subtitleBorderColor || '#000000'
  ...
  const titleBorderColor = data.titleBorderColor || '#000000'
