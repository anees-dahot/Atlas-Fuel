        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            <div className="dyk-header mb-8">
              ...
              <h2 className="text-4xl md:text-5xl font-heading font-bold text-gray-900 uppercase tracking-tight">{heading}</h2>
            </div>
          ...
          <div className="dyk-stats grid grid-cols-2 gap-6">
            {stats.map((stat, index) => (
              <div key={index} className={`dyk-stat p-8 text-center ${index === 2 ? 'bg-primary text-white' : index === 3 ? 'bg-primary-dark text-white' : 'bg-gray-50 border border-gray-100'}`}>
