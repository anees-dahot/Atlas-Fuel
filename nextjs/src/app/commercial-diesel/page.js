...
export const metadata = {
  title: 'Commercial Diesel | Atlas Fuel Australia',
  description: 'Bulk diesel delivery for commercial operations across Australia. Reliable fuel solutions for mining, agriculture, transport, marine, and retail sectors.',
}
...
const fallbackData = {
  ...
  agricultureHeadingColor: '#000000',
  ...
  agricultureContentColor: '#666666',
  ...
  whatWeOfferHeadingColor: '#000000',
...
const fallbackIndustries = {
  ...
  industries: [
    { title: 'Mining Fuel', description: 'We deliver high-quality fuel solutions to power industries, businesses, and communities across Australia.', icon: 'pickaxe', imageUrl: '/images/what-we-do-mining-civil.webp' },
    { title: 'Marine Fuel', description: 'From mining and agriculture to transport and marine, our services are customized to meet every sector\'s needs.', icon: 'anchor', imageUrl: '/images/marine-bunkering.jpg' },
    { title: 'Agriculture', description: 'Our offerings include bulk fuel supply, on-site refueling, logistics, and retail solutions for seamless operations.', icon: 'wheat', imageUrl: '/images/agriculture.webp' },
    { title: 'Fuel Retailer', description: 'Wherever you operate, Atlas Fuel keeps you moving, growing, and succeeding with dependable service.', icon: 'fuel', imageUrl: '/images/what-we-do-retail.webp' },
    { title: 'Fuel Distributor', description: 'Wherever you operate, Atlas Fuel keeps you moving, growing, and succeeding with dependable service.', icon: 'truck', imageUrl: '/images/local-fuel-distributors.jpg' }
  ],
}
...
export default async function CommercialDieselPage() {
  ...
  const industries = {
    ...
    industries: data.industries?.length ? data.industries : fallbackIndustries.industries,
  }
