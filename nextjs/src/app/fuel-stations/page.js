...
export default async function FuelStationsPage() {
  ...
  const fallbackHero = {
    ...
    subtitleColor: 'var(--cms-background)',
    subtitleSize: '14px',
    subtitleBorderEnabled: false,
    subtitleBorderColor: 'var(--cms-background)',
    subtitleBorderWidth: '1px',
    subtitleShadowColor: '',
    title: 'Quality Fuel for Every Journey',
    titleColor: 'var(--cms-background)',
    titleSize: '72px',
    titleBorderEnabled: false,
    titleBorderColor: 'var(--cms-background)',
    ...
    descriptionColor: 'var(--cms-background)',
    descriptionSize: '18px',
    descriptionBorderEnabled: false,
    descriptionBorderColor: 'var(--cms-background)',
  ...
  const fallbackImageGallery = {
    ...
    headingShadowColor: '',
    images: [
      { imageUrl: '/images/placeholders/gallery-placeholder-1.png', alt: 'Add your station photo here' },
      { imageUrl: '/images/placeholders/gallery-placeholder-2.png', alt: 'Add your station photo here' },
      { imageUrl: '/images/placeholders/gallery-placeholder-3.png', alt: 'Add your station photo here' },
      { imageUrl: '/images/placeholders/gallery-placeholder-4.png', alt: 'Add your station photo here' },
      { imageUrl: '/images/placeholders/gallery-placeholder-5.png', alt: 'Add your station photo here' },
      { imageUrl: '/images/placeholders/gallery-placeholder-6.png', alt: 'Add your station photo here' },
      { imageUrl: '/images/placeholders/gallery-placeholder-7.png', alt: 'Add your station photo here' },
      { imageUrl: '/images/placeholders/gallery-placeholder-8.png', alt: 'Add your station photo here' },
      { imageUrl: '/images/placeholders/gallery-placeholder-9.png', alt: 'Add your station photo here' },
    ],
  }
